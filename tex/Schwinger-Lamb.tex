...
\begin{document}
  ...
  \abstract{
    ...
    In this work, we propose a unified reinterpretation of these phenomena within the
    Cosmochrony framework, in which all effective physical observables emerge from a
    non-injective projection of a single pre-geometric relational substrate.
    ...
    pre-geometric relational framework, supporting the view that quantum field theories
  ...
  \input{02-projective-vacuum}
  \input{03-lamb-shift}
  \input{04-schwinger-effect}
  \input{05-fine-structure-constant}
  \input{06-experimental-constraints}
  \input{07-discussion}
