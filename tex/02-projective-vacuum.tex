\section{Projective Origin of Vacuum Effects}
  ...
  Within a relational pre-geometric approach, no such physically populated vacuum is
  postulated.
  ...
  As established in earlier work, this projection is generically non-injective:
...
artifacts}, encoding the finite capacity and resolution of the mapping from
  ...
  Together, these effects illustrate how precision QED phenomena can be consistently
  understood within a unified relational and projective description.
