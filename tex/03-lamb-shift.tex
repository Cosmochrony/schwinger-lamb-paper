\section{The Lamb Shift as Projective Spectral Noise}
  ...
  This finite spectral smearing is consistent with the non-injective character of the
  projection previously identified in the context of Bell-type correlations, where
  effective interactions remain delocalized even in stationary configurations%
  ~\cite{Beau2026b}.
