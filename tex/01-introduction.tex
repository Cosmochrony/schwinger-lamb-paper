\section{Introduction and Motivation}
  ...
  Within a relational pre-geometric approach, the quantum vacuum is not regarded as a
  fundamental physical medium.
  ...
  As developed in previous work, the non-injectivity of this projection implies that
  ...
  a physically populated vacuum, and supports the view that a unified relational and
  projective interpretation can consistently account for phenomena across disparate
  physical regimes.
