\section{The Schwinger Effect as Projective Flux Saturation}
  ...
  Within a relational pre-geometric description, the Schwinger effect admits a
  ...
  projection to sustain smooth relaxation under increasing field intensity, consistent
  with the saturation mechanisms identified in a previous Born--Infeld-type effective
  analysis~\cite{Beau2026c}.
  ...
  Here, such behavior is not imposed at the level of an effective Lagrangian, but
  emerges from the finite transport capacity of the relational substrate itself.

  The Schwinger effect thus exemplifies a general principle: when effective descriptions
  are driven beyond the limits of projectability, stability is restored not by
  divergence, but by reconfiguration.
